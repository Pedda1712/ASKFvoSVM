...
# tune hyperparameters and gpu support here
model = ASKFvoSVM(beta=-10, gamma=0, delta=10, C=10, max_iter=200, subsample_size=1, on_gpu=False)
model.fit([K1, K2, K3, K4, K5], labels)
...
print('got ', right, ' of ', len(y_test), ' train accuracy = ', right/len(y_test))
